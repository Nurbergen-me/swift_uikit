...
//  Project8
//
//  Created by Nurbergen Yeleshov on 25.12.2020.
//
...
class ViewController: UIViewController {
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        if let solutionsPosition = solutions.firstIndex(of: answerText) {
            ...
            let ac = UIAlertController(title: "Sorry", message: "Answer is not correct", preferredStyle: .alert)
